...
/////////////////
const BotName = 'Faza Bintang Bot'; 
const instagram = 'https://instagram.com/fazabintang666'; 
const telegram = 'https://t.me/Fazabintang666'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Syailendra Faza Bintang';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@fazabintang666')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@fazabintang666`)
})
